...
- プロジェクトファイル（VISION.md, PLAN.md, LESSONS.md）
- AI設定ファイル自動検出（README.md, CLAUDE.md, AGENTS.md, GEMINI.md）
...
HANDOFF.md からプロジェクトファイル（VISION.md, PLAN.md, LESSONS.md, Extra files）を復元します。
